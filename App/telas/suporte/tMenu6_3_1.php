...
$sProtocolo->setNomeCampo('WEEK(dataHoraEncerramento)');
$sProtocolo->setValorCampo('WEEK(CURDATE()) AND YEAR(CURDATE()')
?>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Encerramento de Tickets - Semana Atual</h3>
            </div>
            <div class="card-body">
